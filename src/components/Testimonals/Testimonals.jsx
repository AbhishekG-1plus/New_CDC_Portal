  ...
  return (
    <>
      <div className="alumini-container">
        <div className="alumni-testimonial-heading">
          ...
          >
            ...
            <div className="Alumini_data">
              <p>
                ...
                rerum fugit et iusto consequuntur! Consequatur, hic? Aut itaque
                ex accusantium atque consequatur eos, nemo optio facere, quis,
                eius totam architecto?
              </p>
            </div>
          </Paper>
          <Paper
